...
@func_time
def productMax():
    # it's from http://uprate6.wordpress.com/2010/09/03/project-euler-11-my-solution-in-python/
    l = """
    08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
    49 49 99 40 17 81 18 57 60 87 17 40 98 43 69 48 04 56 62 00
    81 49 31 73 55 79 14 29 93 71 40 67 53 88 30 03 49 13 36 65
    ...
    for i in xrange(16):
        for j in xrange(16):
            ...
            maxes.append(t[i][j]*t[i+1][j+1]*t[i+2][j+2]*t[i+3][j+3]) # diagonal 1
            maxes.append(t[i+3][j]*t[i+2][j+1]*t[i+1][j+2]*t[i][j+3]) # diagonal 2
        return max(maxes)
